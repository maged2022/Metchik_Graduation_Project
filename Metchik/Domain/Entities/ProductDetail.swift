...
struct ProductDetail {
    ...
    static let mockData:ProductDetail = ProductDetail(
        ...
        description: "Our Classic Cotton Crewneck T-shirt offers timeless style and comfort. Made from premium 100% cotton, it features a relaxed fit and classic crewneck design. Available in various colors, it's perfect for any occasion. Upgrade your wardrobe with this versatile essential today!"
    )
}
